...
public class CollaborativeFiltering extends RecommendationStrategyBase {
    ...
    private Map<Customer, Map<Book, BigDecimal>> predictedUserRatings = new HashMap<>();    
    ...
    private void predictRatings() {
        for (Customer user : userRatings.keySet()) {
    ...
    public Map<Customer, Map<Book, BigDecimal>> getPredictedUserRatings() {
