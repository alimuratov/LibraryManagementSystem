...
public class Main {
    ...
    private static void initialization() {
        Book book1 = new Book("Book1",
                "A comprehensive guide to marine biology and underwater marine ecosystems research techniques.");
        ...
        Book book6 = new Book("Book6", "Ballet history and the evolution of modern dance styles.");
