...
public class ContentFilteringTest {
	...
	void testGetPreferredBookNames_UserNotInUserRatings() {
	    User user2 = new User("user2"); // New user not in userRatings
	...
	// TODO - hashCode using ids instead of names cuz names can be the same
	@Test
	...
	void testGetPreferredBookNames_UsersWithIdenticalNames() {
		Data data = new Data();
	    User user11a = new User("user11", 1);
	    User user11b = new User("user11", 2); 
	...
	void testCreateUserProfile_PreferredBookNotInTheTfIdfDict() {
	    ...
	    String expectedMessage = "Book not found in TfIdfDict: " + book1.getBookName();
